            ...
            <CenterModal open={openModal} handleClose={handleClose}>
                <div className="w-[380px] md:w-[550px] mx-auto overflow-hidden rounded-lg border-[1px] border-[#367FA9] min-h-[581px] md:min-h-[610px]">
                    ...
                    <div className="flex items-center justify-center text-[16px] md:text-[20px] font-semibold">
                        <div className={`${!tabActivated ? "border-[#1488db] text-black" : "text-[#7d7b7b] border-white"
                            } w-1/2 text-center py-2 text-[16px] lg:text-[20px] border-b-4 cursor-pointer`} onClick={() => { setTabActivated(0) }}>
                            Thông tin máy in
                        </div>
                        <div className={`${tabActivated ? "border-[#1488db] text-black" : "text-[#7d7b7b] border-white"
                            } w-1/2 text-center py-2 text-[16px] lg:text-[20px] border-b-4 cursor-pointer`} onClick={() => { setTabActivated(1) }}>
                            Tùy chỉnh
                        </div>
                    </div>
                    {tabActivated ?
                        ...
                        :
                        <div className="w-full flex flex-col justify-between md:px-[62px] px-[12px] py-[24px] mb-[20px]">
                            <div className="flex flex-row items-center justify-start gap-[90px] mb-[22px]">
                                <p className="text-[#066DCC] text-[16px] md:text-[20px] font-bold w-[80px] md:w-[124px]">ID máy in: </p>
                                <p className="text-black text-[16px] md:text-[20px] font-semibold">{info.id}</p>
                            </div>
                            <div className="flex flex-row items-center justify-start gap-[90px] mb-[22px]">
                                <p className="text-[#066DCC] text-[16px] md:text-[20px] font-bold w-[80px] md:w-[124px]">Nhãn hiệu: </p>
                                <p className="text-black text-[16px] md:text-[20px] font-semibold">{info.brand}</p>
                            </div>
                            <div className="flex flex-row items-center justify-start gap-[90px] mb-[22px]">
                                <p className="text-[#066DCC] text-[16px] md:text-[20px] font-bold w-[80px] md:w-[124px]">Mẫu máy: </p>
                                <p className="text-black text-[16px] md:text-[20px] font-semibold">{info.type}</p>
                            </div>
                            <div className="flex flex-row items-center justify-start gap-[90px] mb-[22px]">
                                <p className="text-[#066DCC] text-[16px] md:text-[20px] font-bold w-[80px] md:w-[124px]">Vị trí: </p>
                                <p className="text-black text-[16px] md:text-[20px] font-semibold">{info.location}</p>
                            </div>
                            <div className="flex flex-row items-center justify-start gap-[90px] mb-[22px]">
                                <p className="text-[#066DCC] text-[16px] md:text-[20px] font-bold w-[80px] md:w-[124px]">Mô tả: </p>
                                <p className="text-black text-[16px] md:text-[20px] font-semibold">{info.description}</p>
                            </div>
                            <div className="flex flex-row justify-end mt-[65px]">
                                <button className="bg-[#ff2121] h-[62px] p-3 w-[154px] rounded-lg text-[16px] md:text-[20px]  font-semibold text-white flex items-center justify-center">
                                    Xóa máy in
                                </button>
                            </div>
                        </div>
