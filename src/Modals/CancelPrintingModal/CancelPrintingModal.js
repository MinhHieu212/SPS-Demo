      ...
      <CenterModal open={openModal} handleClose={handleClose}>
        <div className="w-[350px] md:w-[400px] overflow-hidden rounded-lg border-[1px] border-[#367FA9]">
          ...
          <div className="flex items-center gap-3 justify-center w-full py-2">
            <button
              className="bg-gradient-to-br from-[#999292]  outline-none to-[#B4AFAF] p-3 w-[40%] block rounded-lg text-[16px] font-semibold text-white border-[1px] border-[#367FA9]"
              onClick={handleClose}
            >
              Hủy bỏ
            </button>
            <button className="bg-[#3C8DBC] bg-gradient-to-br outline-none from-cyan-500  p-3 w-[40%] block rounded-lg text-[16px] font-semibold text-white border-[1px] border-[#367FA9]">
              Xác nhận
            </button>
          </div>
        </div>
