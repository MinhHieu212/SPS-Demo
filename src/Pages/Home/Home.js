        ...
        <div className="w-full ">
          <div className="flex flex-col mt-3 md:flex-row items-center justify-center">
            ...
            <div className="w-[100%] md:w-[65%] flex flex-col items-center justify-center  mt-4">
              ...
              <p className="text-center mx-auto text-xl w-[90%] md:w-[80%]">
                Bạn sử dụng hệ thống in ấn này đồng nghĩa với việc bạn đang giúp
                đỡ nhà trường trong công tác quản lý và thúc đẩy chuyển đổi số.
                Nhà trường cũng có thêm nguồn thu nhập để đầu tư vào các cơ sở
                vật chất khác.
              </p>
            </div>
          </div>
