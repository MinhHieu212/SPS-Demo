    ...
    <div className="Support max-w-[1280px] px-[10px] lg:px-[20px] mx-auto mb-5 bg-[white] shadow-sm min-h-[93vh]">
      ...
      <div className="guide text-[16px] lg:text-[18px] mt-4 pb-2 md:pb-3 items-center justify-evenly w-full mx-auto">
        <p className="text-base md:text-xl indent-4">
          Để sử dụng được hệ thống, người quản lý và nhân viên quầy cần
          phải đăng nhập với tài khoản được cấp. Đối với sinh viên, các bạn chỉ cần sử dụng tài khoản trường có sẵn.
        </p>
        ...
        <p className="text-base md:text-xl indent-4">
          ...
          bigdaddy.spssvn@gmail.com để được giải đáp. Chúng tôi không giải
      ...
      <div className="faq w-full flex flex-col gap-[1.25rem] text-base md:text-xl mx-auto">
        ...
        <ul className="m-d expand-list">
          <li data-md-content="300">
            <label className="tab text-base md:text-xl flex flex-row items-center" htmlFor="tab1">
              ...
              <ul>
                <li>
                  <p>
                    ...
                    chúng tôi. Tuy vậy, chúng tôi vẫn sẽ cân nhắc vấn đề giá tiền để đảm bảo không có sự biến động lớn và mức giá duy trì hợp lý.
                  </p>
                </li>
              </ul>
            </div>
          ...
          <li data-md-content="300">
          <label className="tab text-base md:text-xl flex flex-row items-center" htmlFor="tab2">
            2. Tôi không phải sinh viên hay cán bộ nhà trường thì có được sử dụng
              không?
              </label>
          ...
          <li data-md-content="300">
          <label className="tab text-base md:text-xl flex flex-row items-center" htmlFor="tab3">
          ...
          <label className="tab text-base md:text-xl flex flex-row items-center" htmlFor="tab4">
              4. Nếu việc in ấn vì lý do nào đó thất bại, tôi có được trả lại tiền?
            </label>
            ...
            <div className="content">
              <ul>
                <li>
                  <p>
                    Số dư in ấn sẽ được hoàn trả vào tài khoản trên web của bạn. Bạn có thể tiếp tục
                    sử dụng cho các hoạt động sau này.
                  </p>
                </li>
              </ul>
            </div>
