  ...
  return (
    <div className="Support max-w-[1280px] px-[15px] md:px-[32px] lg:px-[70px] mx-auto">
      ...
      <div className="guide text-1xl lg:text-2xl mt-4 pb-2 md:pb-3 items-center justify-evenly w-full mx-auto">
        ...
        <ul class="list-disc ml-8 pl-2">
          <li>Đối với sinh viên: Sinh viên đăng nhập bằng tài khoản trường có sẵn. Đối với sinh viên: Sinh viên đăng nhập bằng tài khoản trường có sẵn.</li>
       ...
       <div className="faq w-full text-1xl lg:text-2xl items-center justify-evenly mx-auto">
        <h2 className="text-2xl lg:text-3xl font-bold mt-4 pb-1 md:pb-2">CÂU HỎI THƯỜNG GẶP</h2>
